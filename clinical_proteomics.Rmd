...
dataset = setup_contrasts(dataset, contrast_list = list(c("AZD_BNT_visit_0", "AZD_BNT_visit_4"), c("AZD_BNT_visit_0", "AZD_BNT_visit_8"), c("BNT_BNT_visit_0", "BNT_BNT_visit_4"), c("BNT_BNT_visit_0", "BNT_BNT_visit_8")))
```
...
dataset = analysis_quickstart(
  ...
  dea_algorithm = c("ebayes", "deqms"), #, "msempire", "msqrob" # statistics; apply multiple methods in parallel/independently
