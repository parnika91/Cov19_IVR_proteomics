...
dataset = setup_contrasts(dataset, contrast_list = list(c("AZD_BNT_visit_0", "AZD_BNT_visit_1"),c("AZD_BNT_visit_0", "AZD_BNT_visit_1"), c("AZD_BNT_visit_0", "AZD_BNT_visit_4"), c("AZD_BNT_visit_0", "AZD_BNT_visit_8"), c("BNT_BNT_visit_0", "BNT_BNT_visit_4"), c("BNT_BNT_visit_0", "BNT_BNT_visit_8"), c("AZD_BNT_visit_5", "AZD_BNT_visit_6"), c("BNT_BNT_visit_5", "BNT_BNT_visit_6")))
```
...
dataset = dea(dataset, algo_de = "deqms", qval_signif = 0.05, fc_signif = NA)
